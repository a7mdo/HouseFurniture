...
class FurnitureDetailViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    @IBAction func choosePhotoButtonTapped(_ sender: Any) {
        ...
        if UIImagePickerController.isSourceTypeAvailable(.photoLibrary) {
            let chooseImageAction = UIAlertAction(title: "Choose image from photo library", style: .default) { (alert: UIAlertAction!) in
        ...
        if UIImagePickerController.isSourceTypeAvailable(.camera) {
            let takeImageAction = UIAlertAction(title: "Take a photo", style: .default) { (alert: UIAlertAction!) in
    ...
    @IBAction func actionButtonTapped(_ sender: Any) {
        let activityViewController = UIActivityViewController(activityItems: [furniture?.imageData! as Any], applicationActivities: nil)
